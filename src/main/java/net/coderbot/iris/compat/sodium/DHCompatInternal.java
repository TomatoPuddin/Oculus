...
public class DHCompatInternal {
    ...
    private net.coderbot.iris.compat.dh.IrisLodRenderProgram solidProgram;
    private net.coderbot.iris.compat.dh.IrisLodRenderProgram translucentProgram;
    private net.coderbot.iris.compat.dh.IrisLodRenderProgram shadowProgram;
    private GlFramebuffer dhTerrainFramebuffer;
    private net.coderbot.iris.compat.dh.DhFrameBufferWrapper dhTerrainFramebufferWrapper;
    private GlFramebuffer dhWaterFramebuffer;
    private GlFramebuffer dhShadowFramebuffer;
    private net.coderbot.iris.compat.dh.DhFrameBufferWrapper dhShadowFramebufferWrapper;
    ...
    public net.coderbot.iris.compat.dh.IrisLodRenderProgram getSolidShader() {
        return solidProgram;
    }
    ...
    public net.coderbot.iris.compat.dh.DhFrameBufferWrapper getSolidFBWrapper() {
        return dhTerrainFramebufferWrapper;
    }

    public net.coderbot.iris.compat.dh.IrisLodRenderProgram getShadowShader() {
    ...
    public net.coderbot.iris.compat.dh.DhFrameBufferWrapper getShadowFBWrapper() {
        return dhShadowFramebufferWrapper;
    }

    public net.coderbot.iris.compat.dh.IrisLodRenderProgram getTranslucentShader() {
        if (translucentProgram == null) {
            return solidProgram;
        }
